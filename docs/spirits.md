...
“通灵”状态：灵珏护体，受到每段伤害时，降低（10%自身灵气层数，向下取整）点伤害。
...
**毒爪**（3）：目标为一个敌方精灵。对目标造成（80%自身物攻）物理伤害。目标的每层“中毒”会使此次伤害倍率提升（16%自身物攻），最多计入10层；然后使其触发一次中毒效果。
...
- （彻甲：状态效果。对敌方精灵释放普攻或技能时，若自身拥有“罡气”且目标“驱邪”层数小于4层，则移除自身1层“罡气”，并赋予目标1层“驱邪”。对拥有2/3/4层“驱邪”的目标造成伤害时，此伤害暴击率提升25%/50%/50%，暴击效果提升40%/40%/80%。）
...
- 毛血旺：目标为全部敌方精灵。消耗全部“火力”，每消耗3层“火力”，就给予所有目标1层“灼烧”；然后给予所有目标“毛血旺”负面效果，持续3回合：受到的持续伤害提高15%，持续期间再次获得此效果会重置持续时间。
...
| 能力值 | 生命 | 物攻 | 魔攻 | 物防 | 魔防 | 速度 |
| --- | --- | --- | --- | --- | --- | --- |
| | 600 | 120 | 120 | 120 | 120 | 140 |

**必有我师**（被动）：游戏开始时，我方首位精灵获得“师傅”状态效果。场上存在“师傅”时，使自身双攻提高12%，攻击伤害的暴击率提升30%，暴击效果提升60%。师傅发动攻击后，自身获得一次额外行动，自动对此次攻击的随机一个目标释放特殊技能“学会了！”，此效果最多可触发1次，自身回合开始时重置可触发次数。

**学会了！**（特殊技能）：目标为一个敌方精灵。对目标造成（50%自身物攻）物理伤害；使“师傅”也获得自身“必有我师”的双攻、暴击率和暴击效果提升效果，持续2回合。

**普通攻击**：目标为一个敌方精灵。对目标造成（100%自身物攻）物理伤害。

**师傅请喝茶**（2）：目标为除自身外的一个己方精灵。清除我方所有精灵的“师傅”状态效果；使目标获得“师傅”效果；使自身速度提高10%，持续2回合。

**百家拳法**（2）：目标为一个敌方精灵。对目标造成（100%自身物攻）物理伤害；若场上存在师傅，则额外造成一段（100%师傅双攻的较高值）物理伤害。

**学神不学形**（5）：目标为自身。使自身获得“学神”状态效果：自身发动攻击后，若场上存在师傅，使师傅对此次攻击的随机一个目标造成一段（30%师傅双攻的较高值）物理附加伤害。
