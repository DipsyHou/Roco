...
**必有我师**（被动）：游戏开始时，若自身不处于我方首位，使我方首位精灵获得“师傅”状态效果。场上存在“师傅”时，自身双攻提高10%，攻击伤害的暴击率提升20%，暴击效果提升50%。师傅发动攻击后，自身获得一次额外行动，自动对此次攻击的随机一个目标释放特殊技能“学会了！”；若不存在这样的目标，则以随机一个敌方精灵为目标；此效果最多可触发1次，自身回合开始时重置可触发次数。
...
**肉盾**（被动）：基于自身物防与魔防之和的8%，提高全体己方精灵的物防与魔防；自身受到的伤害提高50%。（实现时在游戏开始时给自己挂一个“肉盾”状态效果）

**普通攻击**：目标为一个敌方精灵。对目标造成（100%自身物攻）物理伤害。

**血墙**：此技能固定不消耗能量。目标为自身。消耗10%最大生命值（不致死），获得“血墙”正面效果，持续4回合，期间再次获得此效果会重置持续时间：提高自身50%双防。

**狂宴**（4）：目标为自身。回复（50%自身已损生命）生命。
