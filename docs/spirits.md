...
**痛苦**（被动）：造成伤害时，若目标有“中毒”效果，使此次伤害提升30%。

- （中毒：负面效果，可叠加。在回合结束时受到（1%自身生命上限 × 自身中毒层数）点固定伤害，然后减少一层。）

**普通攻击**：目标为一个敌方精灵。对目标造成（100%自身物攻）点物理伤害。

**毒刺**（3）：目标为全体敌方精灵。重复7次：对随机一个敌方精灵造成（20%自身物攻）点物理伤害，并赋予其1层“中毒”。

**厉毒**（2）：目标为一个敌方精灵。赋予目标3层“中毒”，然后使其触发一次中毒效果。

**毒爪**（3）：目标为一个敌方精灵。对目标造成（100%自身物攻）点物理伤害。目标的每层“中毒”会使此次伤害倍率提升（15%自身物攻），最多计入10层。
...
- （彻甲：状态效果。对敌方精灵释放普攻或技能时，若自身拥有“罡气”且目标“驱邪”层数小于4层，则移除自身1层“罡气”，并赋予目标1层“驱邪”。对拥有“驱邪”目标造成伤害时：该伤害可暴击；当目标“驱邪”层数为2/3/4时，此伤害暴击率提升30%/40%/60%，暴击伤害提高50%/50%/80%。）
...
- （招架：状态效果，可叠加，最多5层。获得（5% * （自身“招架”层数））伤害减免。若自身已有“招架”，受到伤害时再获得1层“招架”。在自身回合开始时，若自身拥有“招架”，则获得一次额外行动：使用技能“截拳”或“反扑”。）
