    ...
    skills=[
        ...
        SkillDef(
            ...
            description=(
                ...
                "若场上存在师傅，使师傅对目标造成一段（48%师傅双攻的较高值）对应属性附加伤害。"
            ),
            cooldown=0,
            target_type=TargetType.single_enemy,
            energy_cost=2,
        ...
        SkillDef(
            ...
            name="学神不学形",
            description=(
                "能量 3。使自身获得“学神”状态效果，持续5回合，期间再次获得此效果会重置持续时间："
                "自身发动攻击后，若场上存在师傅，"
                "使师傅对此次攻击的随机一个目标造成一段（32%师傅双攻的较高值）对应属性附加伤害；"
                "若不存在这样的目标，则以随机一个敌方精灵为目标。"
            ),
            cooldown=0,
